...
## 6. RESEARCH ANNEX
Search arXiv (arxiv.org) and SSRN (ssrn.com) for papers published in the last 7 days relevant to: AI capabilities and safety, AI governance and policy, geopolitics of technology, semiconductor supply chains, autonomous systems, or great power competition. List up to 8 papers. For each: title, authors, one-sentence summary, and a link.
...
- Conversational but precise and analytical. No fluff, no filler. Every sentence earns its place.
